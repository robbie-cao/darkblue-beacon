...
BOOL CWsOtaUpgradeDlg::GetDeviceList()
{
    ...
    if ((hardwareDeviceInfo = SetupDiGetClassDevs (NULL, NULL, NULL, DIGCF_ALLCLASSES | DIGCF_PRESENT)) != INVALID_HANDLE_VALUE)
    {
        ...
        GUID guid;
        if (m_bWin8)
            guid = GUID_WS_UPGRADE_SERVICE;
        else
        {
            guid.Data1 = (GUID_WS_UPGRADE_SERVICE.Data4[4]     ) + (GUID_WS_UPGRADE_SERVICE.Data4[5] << 8) + (GUID_WS_UPGRADE_SERVICE.Data4[6] << 16) + (GUID_WS_UPGRADE_SERVICE.Data4[7] << 24);
            guid.Data2 = (GUID_WS_UPGRADE_SERVICE.Data4[2]     ) + (GUID_WS_UPGRADE_SERVICE.Data4[3] << 8);
            guid.Data3 = (GUID_WS_UPGRADE_SERVICE.Data4[0]     ) + (GUID_WS_UPGRADE_SERVICE.Data4[1] << 8);
            guid.Data4[0] = (GUID_WS_UPGRADE_SERVICE.Data3      ) & 0xff;
            guid.Data4[1] = (GUID_WS_UPGRADE_SERVICE.Data3 >> 8 ) & 0xff;
            guid.Data4[2] = (GUID_WS_UPGRADE_SERVICE.Data2      ) & 0xff;
            guid.Data4[3] = (GUID_WS_UPGRADE_SERVICE.Data2 >> 8 ) & 0xff;
            guid.Data4[4] = (GUID_WS_UPGRADE_SERVICE.Data1      ) & 0xff;
            guid.Data4[5] = (GUID_WS_UPGRADE_SERVICE.Data1 >> 8 ) & 0xff;
            guid.Data4[6] = (GUID_WS_UPGRADE_SERVICE.Data1 >> 16) & 0xff;
            guid.Data4[7] = (GUID_WS_UPGRADE_SERVICE.Data1 >> 24) & 0xff;
        }
...
LRESULT CWsOtaUpgradeDlg::OnNotified(WPARAM bConnected, LPARAM lparam)
{
    ...
    if (pValue->len == 1)
    {
        m_pDownloader->ProcessEvent((pValue->value[0] == WS_UPGRADE_STATUS_OK) ? WSDownloader::WS_UPGRADE_RESPONSE_OK : WSDownloader::WS_UPGRADE_RESPONSE_FAILED);
    }
    free (pValue);
