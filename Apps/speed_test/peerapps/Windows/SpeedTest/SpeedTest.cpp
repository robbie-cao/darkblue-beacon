...
GUID guidSvcSpeedTest;
GUID guidCharSpeedTestControlPoint;
GUID guidCharSpeedTestData;
...
BOOL CSpeedTestApp::InitInstance()
{
	...
	if (IsOSWin8())
	{
        ...
        guidSvcSpeedTest                = GUID_SPEED_TEST_SERVICE;
        guidCharSpeedTestControlPoint   = GUID_SPEED_TEST_CHARACTERISTIC_CONTROL_POINT;
        guidCharSpeedTestData           = GUID_SPEED_TEST_CHARACTERISTIC_DATA;
	}
	else if (IsOSWin7())
	{
		dlg.m_bWin8 = FALSE;
        ...
        BtwGuidFromGuid(&guidSvcSpeedTest, &GUID_SPEED_TEST_SERVICE);
        BtwGuidFromGuid(&guidCharSpeedTestControlPoint, &GUID_SPEED_TEST_CHARACTERISTIC_CONTROL_POINT);
        BtwGuidFromGuid(&guidCharSpeedTestData, &GUID_SPEED_TEST_CHARACTERISTIC_DATA);
	}
	else
	{
